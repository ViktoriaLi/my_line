...
ft_putchar_fd.o ft_putstr_fd.o ft_strjoin.o ft_strsub.o ft_putendl.o ft_strclr.o ft_strmap.o ft_strtrim.o ft_lstadd.o ft_lstdel.o \
...
$(OFILES): %.o:%.c
	gcc -c -Wall -Wextra -Werror $(SFILES) libft.h
